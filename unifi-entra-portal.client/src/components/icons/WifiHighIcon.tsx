...
/**
 * Wi-Fi signal icon (Phosphor "regular" set, self-hosted — see
 * design_handoff_wlan_captive_portal/README.md, "self-host Inter and the
 * icons"). Shown next to the SSID on the Choose step.
 */
export function WifiHighIcon({ size = '1em', className }: IconProps) {
    return (
